package Collections;
public class MySet<KV> {//Key - Value
    ...
    public void add(KV obj){
        System.out.println(obj.toString() + " - has added in set");
    ...
    private class Node<KV>{
        private MyList<Node<KV>> nodes = null;
        private int hash;
        ...
        public MyList<Node<KV>> getList() {
            return nodes;
        }
    }

    private String printMySet(){
        String s = "{ ";
        for(Node n : mass){
